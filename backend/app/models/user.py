...
class User(Base):
    ...
    # Reject any JWT whose iat is older than this — used by "sign out everywhere"
    min_token_iat: Mapped[datetime | None] = mapped_column(DateTime(timezone=True), nullable=True)
